module RedmineChilliPdfHelper
  # Public directory of RedmineChilliPDF plugin JavaScript files
  PLUGIN_JS_DIR = Rails.root.join('public','plugin_assets', 'redmine_chilli_pdf', 'javascripts')

  # Public directory of RedmineChilliPDF plugin stylesheets
  PLUGIN_CSS_DIR = Rails.root.join('public','plugin_assets', 'redmine_chilli_pdf', 'stylesheets')
  ...
  #         plugin_assets/redmine_chilli_pdf/stylesheets directory, formatting
  ...
  def redmine_chilli_pdf_stylesheets(wants_html)
  ...
  def redmine_chilli_pdf_javascripts(wants_html)
  ...
  # Public: Generates an image tag with the appropriate mark-up for the RedmineChilliPDF
  #         'logo'.
  #
  # wants_html - specifies whether the 'src' attribute should be formatted
  #              for HTML or PDF requests (local vs. relative paths). Added to
  ...
  def logo_img_tag(wants_html)
    if RedmineChilliPDF::Config.logo_url?
      img_tag = image_tag(RedmineChilliPDF::Config.logo_url, :id => "redmine-chilli-pdf-logo")
  ...
  private
    ...
    # of RedmineChilliProject as well as standard static assets (nested under RAILS_ROOT/public),
